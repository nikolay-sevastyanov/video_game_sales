...
В этом анализе я попытался привнести ясности в события индустрии платных видеоигр. Он способен принести ценности как и для исторического анализа, так и с целью "держать руку на пульсе". Благодарю вас за внимание. :)

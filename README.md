...
<img src="images/df_year_genre_global_dist.png" alt="df_year_genre_global_dist.png" width="320"/>

### Тренды Северной Америки 
В Северной Америке тренды жанров схожи с глобальными.

<img src="images/df_year_genre_na_dist.png" alt="df_year_genre_na_dist.png" width="320"/>

### Тренды Европы  
В Европе тренды жанров схожи с глобальными, на слегка увеличен спрос на игры жанра "гонки".

<img src="images/df_year_genre_eu_dist.png" alt="df_year_genre_eu_dist.png" width="320"/>

### Тренды Японии
В Японии тренды жанров схожи с глобальными, но жанром топ-1 является "RPG".

<img src="images/df_year_genre_jp_dist.png" alt="df_year_genre_jp_dist.png" width="320"/>

### Тренды остальных регионов
В остальных регионах тренды жанров  схожи с глобальными.

<img src="images/df_year_genre_other_dist.png" alt="df_year_genre_other_dist.png" width="320"/>
